...
<main>
    ...
    <div class="forms">
        <form action="./add.php" method="post">
            ...
            <a href="/signin">Já tem uma conta? Entre</a>
        </form>
    </div>
</main>
...
.contents {
    ...
    height: 100vh;
    width: 50%;
    background-image: linear-gradient(to right bottom, #0038d8, #0035bb, #00319d, #002b80, #002563);
    color: var(--white);
}
...
.forms {
    ...
    height: 100vh;
    width: 50%;
    background-image: url('https://wallpapercave.com/wp/wp2294708.jpg');
